...
with file_container:
    ...
    if uploaded_file is None:
        ...
        # Use a dropdown for user selection
        user_selection = st.selectbox("Select Yes if a Pivot Table or Select No if not a Privot Table:", ["Choose One", "Yes", "No"])

        # Check if user selected "Yes" or "No"
        if user_selection in ["Yes", "No"]:
            # Display a button if user selected "Yes" or "No"
            if st.button("Reformat DG Spreadsheet"):
                ...
                if user_selection == "Yes":
                    ...
                    st.write("Pivot table formatted successfully.")
                ...
                new_filename = f"formatted_spreadsheet.xlsx"

                # Save the formatted workbook if it's not None
...
#======================================================================================================================
# END Useing the container created earlier creates the uploader for formatting the Distribution Grid spreadsheet.  Also
# a selection for choosing a Privot table type Spreadsheet or just a vertical column spreadsheet.  Based on your
# selection yes it is a pivot table then the function format_pivot_table is called to handle for transformation
# and if no then the function format_non_pivot_table is called for sheet validation
#======================================================================================================================
